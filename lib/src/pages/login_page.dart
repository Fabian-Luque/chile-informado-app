      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                Text('Ingreso', style: TextStyle(fontSize: 20.0, color: Colors.blueAccent)),
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: <Color> [
            ...
            Color.fromRGBO(115, 194, 251, 1.0)
          ]
        )
      ),
    );
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            children: <Widget>[
              Image(
                image: AssetImage('assets/chile-informado.jpeg'),
                width: 150.0,
              ),
              SizedBox( height: 10.0, width: double.infinity ),
              // Text('Chile Informado', style: TextStyle(color: Colors.white, fontSize: 25.0))
            ],
          ),
        )
